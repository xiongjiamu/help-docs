# 电子邮件通知[](#电子邮件通知 "Permalink")
 ...
 通知使您可以随时了解 CODE CHINA 中发生的事情，启用通知后，您可以接收有关 Issue、合并请求和 Epic 活动的更新，通知将通过电子邮件发送。
...
通知的数量可能是巨大的，CODE CHINA 允许您调整收到的通知。例如，您可能希望收到有关特定项目中所有活动的通知，而对于其他项目，仅当您的名字被提及时才得到通知。
...
通知电子邮件包括特定于 CODE CHINA 的标题。您可以根据这些标头的内容过滤通知电子邮件，以更好地管理您的通知。 例如，您可以过滤特定项目的所有电子邮件，在该项目中您将被分配合并请求或问题。

下表列出了所有特定于 CODE CHINA 的电子邮件标题：
